function displayDailyChart() {
    var dailyBox = document.getElementById("cnx-daily-box");
    var hoursBox = document.getElementById("cnx-hours-box");
...
$(document).ready(function () {
    ...
    function createDailyCNXChart (results) {
        console.log(results['results']['weather']);
    ...
    $.ajax({ 
        ...
        success: function(results) {
            ...
            // console.log(results['results']['weather']);
            createHoursCNXChart(results)

        }, 
    });


    function createHoursCNXChart (results) {
        console.log(results['results']['weather']);
